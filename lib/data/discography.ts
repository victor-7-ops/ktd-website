...
export const discography: Release[] = [
  {
    ...
    spotify: "https://open.spotify.com/track/1fTBUhfsev679jNoMEXkuf",
    apple: null,
    youtube: null,
    accent: "#16213e",
    highlight: false,
  },
  {
    ...
    spotify: "https://open.spotify.com/track/2bTt3jxtX1iqrj9VCPBFya",
    apple: null,
    youtube: null,
    accent: "#0d1f1a",
    highlight: false,
  },
  {
    ...
    spotify: "https://open.spotify.com/track/03PfYeqAJJwgorK1hPzsLN",
    apple: null,
    youtube: null,
    accent: "#2a1a0a",
    highlight: false,
  },
  {
    ...
    spotify: "https://open.spotify.com/track/5hql5zFXFwdlhClwq8oklP",
    apple: null,
    youtube: null,
    accent: "#2a0a0a",
    highlight: true,
